...
<div id="top" class="one-page-home">
  ...
  <section id="education" class="one-page-section" aria-labelledby="education-heading">
    <h2 id="education-heading">Education</h2>
    <div class="section-body education-list">
      <div class="education-item">
        <div>
          <h3>University of Rochester</h3>
          <p>Ph.D. Student in Electrical and Computer Engineering</p>
          <p>Advisor: Prof. Lisha Chen</p>
        </div>
      ...
      <div class="education-item">
        <div>
          ...
          <p>Bachelor of Engineering in Information Engineering</p>
        </div>
        <span class="education-date">Aug. 2021–Jun. 2025</span>
      </div>
    </div>
  </section>

  <section id="awards" class="one-page-section" aria-labelledby="awards-heading">
